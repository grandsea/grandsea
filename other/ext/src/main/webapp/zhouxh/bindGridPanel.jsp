...
.icon-grid {
	background-image: url(../ext/examples/shared/icons/fam/grid.png)
		!important;
}
...
.add {
	background-image: url(../ext/examples/shared/icons/fam/add.gif)
		!important;
}

.option {
	background-image: url(../ext/examples/shared/icons/fam/plugin.gif)
		!important;
}

.remove {
	background-image: url(../ext/examples/shared/icons/fam/delete.gif)
		!important;
}
